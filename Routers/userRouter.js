...
Router.post('/verify-email', async(req,res)=>{
    try{
        ...
        const resetUrl =  process.env.baseUrl + `/email-verified?encryptedData=${encrypted}&token=${emailVerifyToken}&ivHex=${iv.toString('hex')}`;
        const emailContent = ( 
            `<!DOCTYPE html>
            <html lang="en">
                <head>
                ...
                <body>
                    <div class='verify'>
                        <h1 class='verify-h1'>Welcome to Nith-Blog</h1>
